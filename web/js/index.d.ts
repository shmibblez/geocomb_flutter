...
export declare class HashProperties {
    ...
    constructor(res: number, row: number, col: number, mo: MapOrientation | any, rm: RotationMethod | any);
}
/**
...
export declare class Icosahedron {
     ...
     */
    static onReady(mapOrientation?: MapOrientation, rotationMethod?: RotationMethod): Promise<Icosahedron>;
    /**
...
export declare class GPoint3 extends Point3 {
     ...
     * @param isPC
     */
    constructor(x: number, y: number, z: number, res: number, row: number, col: number, mo: MapOrientation | any, rm: RotationMethod | any, triNum?: number, isPC?: boolean);
}
